...
step3 = importlib.import_module("tml-solutions.MYFIRSTPROJECT-bfac.tml_read_MQTT_step_3_kafka_producetotopic_dag-MYFIRSTPROJECT-bfac")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-MYFIRSTPROJECT-bfac",
