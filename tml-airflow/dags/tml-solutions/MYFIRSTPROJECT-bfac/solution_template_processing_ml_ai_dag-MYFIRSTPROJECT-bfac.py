...
step3 = importlib.import_module("tml-solutions.MYFIRSTPROJECT-bfac.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-MYFIRSTPROJECT-bfac")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-MYFIRSTPROJECT-bfac",
