...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_CYT-160-Project2-Revised-bfac", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_CYT-160-Project2-Revised-bfac"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
