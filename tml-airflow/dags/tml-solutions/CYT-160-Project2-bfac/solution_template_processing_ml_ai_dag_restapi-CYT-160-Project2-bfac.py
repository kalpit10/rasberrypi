...
step1 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_1_getparams_dag-CYT-160-Project2-bfac")
step2 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_2_kafka_createtopic_dag-CYT-160-Project2-bfac")
step3 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-CYT-160-Project2-bfac")
step4 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_4_kafka_preprocess_dag-CYT-160-Project2-bfac")
step5 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_5_kafka_machine_learning_dag-CYT-160-Project2-bfac")
step6 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_6_kafka_predictions_dag-CYT-160-Project2-bfac")
step7 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_7_kafka_visualization_dag-CYT-160-Project2-bfac")
step8 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_8_deploy_solution_to_docker_dag-CYT-160-Project2-bfac")
step9 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_9_privategpt_qdrant_dag-CYT-160-Project2-bfac")
step10 = importlib.import_module("tml-solutions.CYT-160-Project2-bfac.tml_system_step_10_documentation_dag-CYT-160-Project2-bfac")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-CYT-160-Project2-bfac",
