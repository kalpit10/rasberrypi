...
default_args = {
 ...
 'solutionname': 'CYT-160-Project2-bfac',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_CYT-160-Project2-bfac", default_args=default_args, tags=["tml_system_step_1_getparams_dag_CYT-160-Project2-bfac"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
