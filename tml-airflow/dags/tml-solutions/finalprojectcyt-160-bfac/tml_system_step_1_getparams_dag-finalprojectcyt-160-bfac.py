...
default_args = {
 ...
 'solutionname': 'finalprojectcyt-160-bfac',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_finalprojectcyt-160-bfac", default_args=default_args, tags=["tml_system_step_1_getparams_dag_finalprojectcyt-160-bfac"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
